...
const CheckOut = () => {
  ...
  useEffect(() => {
    ...
    setratingNumbers(
      storedratingNumber !== null ? ratingNumber[storedratingNumber] : null
    );

    setratingAmounts(
      storedratingNumber !== null ? ratingAmount[storedratingNumber] : null
    );
  }, []);
            ...
            >
              <div className="divComplete">
                ...
                <div className="btndiv">
                  <Link to="/viewbook" className="linking">
